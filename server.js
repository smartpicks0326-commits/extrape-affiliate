      ...
      stores = await Promise.all(stores.map(async (s) => {
        ...
        try {
          ...
          if (host.includes('flipkart.com') || host.includes('dl.flipkart.com')) {
            // Flipkart: ExtraPe accepts www.flipkart.com URLs with all original params.
            // Only force https and normalise hostname — do NOT strip params (breaks ExtraPe).
            u.hostname = 'www.flipkart.com';
            u.protocol = 'https:';
            cleanUrl   = u.toString(); // cleanUrl = full URL with all original params
            extrapeUrl = cleanUrl;     // same — send full URL to ExtraPe
